...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/NE_output/phi_3_mini/PAIRWISE_IMPORTANCE_SAMPLING_rollout_mctsr_NE_Phi_3_mini_AIME.csv", encoding='utf-8', index=False)
