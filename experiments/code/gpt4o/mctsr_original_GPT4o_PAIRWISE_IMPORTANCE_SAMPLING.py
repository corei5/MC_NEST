...
if __name__ == "__main__":
    ...
    def run_mcts_and_save(df, index, rollouts):
        for max_rollout in rollouts:
            try:
                mcts = MCTSrGPT4o(problem=df.at[index, 'Problem_Statement'], max_rollouts=max_rollout)
    ...
    for index, row in df.iterrows():
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/original/gpt4o/PAIRWISE_IMPORTANCE_SAMPLING_rollout_mctsr_original_AIME.csv", encoding='utf-8', index=False)
