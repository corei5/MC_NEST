...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/AIME_2025/DUMMY_ANSWER/1_DUMMY_ANSWER_PAIRWISE_IMPORTANCE_SAMPLING_rollout_mctsr_NE_AIME_2025_gpt-o3-thinking.csv", encoding='utf-8', index=False)
