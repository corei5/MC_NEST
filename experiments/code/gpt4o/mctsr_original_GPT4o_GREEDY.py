...
class MCTSr(BaseModel):
    ...
    selection_policy: int = PAIRWISE_IMPORTANCE_SAMPLING #PAIRWISE_IMPORTANCE_SAMPLING #GREEDY #IMPORTANCE_SAMPLING
    initialize_strategy: int = DUMMY_ANSWER #ZERO_SHOT
    ...
    def select_node(self):
        ...
        if self.selection_policy == GREEDY:
            ...
            print("..................IMPORTANCE_SAMPLING Original...............")
            ...
            print("..................PAIRWISE_IMPORTANCE_SAMPLING Original...............")
...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/AIME_2025/DUMMY_ANSWER/2_DUMMY_ANSWER_original_PAIRWISE_IMPORTANCE_SAMPLING_rollout_mctsr_NE_AIME_2025_gpt-o3.csv", encoding='utf-8', index=False)
