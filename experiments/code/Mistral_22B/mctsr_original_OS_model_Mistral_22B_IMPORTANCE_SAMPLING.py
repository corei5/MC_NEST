...
class MCTSr(BaseModel):
    ...
    selection_policy: int =  IMPORTANCE_SAMPLING #GREEDY #PAIRWISE_IMPORTANCE_SAMPLING #IMPORTANCE_SAMPLING # 
...
if __name__ == "__main__":
    ...
    for index, row in df.iloc[116:].iterrows():  # Slice the DataFrame to start at index 15
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/original/Mistral_22B/IMPORTANCE_SAMPLING_rollout_mctsr_NE_Mistral_22B_AIME_from_116.csv", encoding='utf-8', index=False)
