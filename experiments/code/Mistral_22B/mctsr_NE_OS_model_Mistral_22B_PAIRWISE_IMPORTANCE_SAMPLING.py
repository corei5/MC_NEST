...
if __name__ == "__main__":
    ...
    for index, row in df.iloc[115:].iterrows():  # Slice the DataFrame to start at index 15
        ...
        df.to_csv("/nfs/home/rabbyg/CAG/AIME_dataset_exp/output/NE_output/Mistral_22B/PAIRWISE_IMPORTANCE_SAMPLING_rollout_mctsr_NE_Mistral_22B_AIME_from_115.csv", encoding='utf-8', index=False)
